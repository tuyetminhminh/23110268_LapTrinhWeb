        ...
        <c:forEach var="c" items="${listcate}">
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/category/detail?id=${c.id}" class="btn btn-sm btn-info">Xem</a>
                    <c:if test="${currentUser.roleId == 3 or c.user.id == currentUser.id}">
                        <form action="${pageContext.request.contextPath}/admin/category/edit" method="post" style="display: inline">

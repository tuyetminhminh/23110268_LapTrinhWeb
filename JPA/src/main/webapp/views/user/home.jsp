...
<a href="${pageContext.request.contextPath}/user/category/add"
	...
	<tbody>
		<c:forEach var="c" items="${listcate}">
			<tr>
				...
				<td><a
					href="${pageContext.request.contextPath}/user/category/edit?id=${c.id}"
					class="btn btn-sm btn-warning">Sửa</a>
					<form
						action="${pageContext.request.contextPath}/user/category/delete"
